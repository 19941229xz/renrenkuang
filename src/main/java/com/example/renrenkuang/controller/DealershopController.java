...
public class DealershopController {
    ...
    @PostMapping("/batchDeleteDealershopByIds")
    public Object batchDeleteDealershopByIds(@RequestBody int[] ids){
	    int affectedNum=0;
        for (int id:ids){
            affectedNum+= (dealershopService.removeDealershopById(id)?1:0);
        }
