...
public class PostmessageController {
    ...
    @PostMapping("/batchDeletePostmessageByIds")
    public Object batchDeletePostmessageByIds(@RequestBody int[] ids){
	    int affectedNum=0;
        for (int id:ids){
            affectedNum+= (postmessageService.removePostmessageById(id)?1:0);
        }
